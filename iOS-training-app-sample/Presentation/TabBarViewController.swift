...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        homeView.tabBarItem = UITabBarItem(title: "home", image:  UIImage(named: "tab_icon_seelcted"), tag: 1)
        let homeBar = UINavigationController(rootViewController: homeView)

        let logoutView = LogoutViewController.createInstance()
        logoutView.tabBarItem = UITabBarItem(title: "logout", image:  UIImage(named: "tab_icon_seelcted"), tag: 2)
